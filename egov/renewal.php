...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO applicants (
        ...
        citizenship_photo, passport_type, pages, location, passport_issue_date, 
        passport_expired_date, passport_issue_district
    ) VALUES (
    ...
    $params = [
        ...
        ':passport_issue_district' => $_POST['passport_issue_district'] ?? ''
    ];
